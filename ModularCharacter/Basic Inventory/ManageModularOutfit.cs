...
public class ManageModularOutfit : MonoBehaviour
{
    ...
    private void Awake()
    {
        nameMap["Chr_HeadCoverings_Base_Hair_01"] = "Ribbon Cap";
        nameMap["Chr_HeadCoverings_Base_Hair_02"] = "Witches hat";
        nameMap["Chr_HeadCoverings_Base_Hair_03"] = "Feather Bonnet";
