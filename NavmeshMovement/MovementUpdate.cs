...
public class MovementUpdate : MonoBehaviour
{
    ...
    // values for BehaviourTrees to bind to
    public float normalSpeed;
    public float chaseSpeed;
    public float chaseDistance;
    public float fleeDistance;

    private bool notCloseToDestination { get { return Vector3.Distance(navmesh.steeringTarget, transform.position) > 0.2f; } }
    ...
    void Update()
    {
        ...
        // only rotate y axis
        dir.y = 0;
        // ensure we have a valid rotation, and agent is moving, and not too close to destination
        if (dir != Vector3.zero && speed != 0 && notCloseToDestination)
        {
