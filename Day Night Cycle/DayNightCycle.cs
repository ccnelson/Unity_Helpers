...
public class DayNightCycle : MonoBehaviour
{
    ...
    public enum timePhases { MORNING, AFTERNOON, EVENING, NIGHT }
    public timePhases dayPhase;

    public TimeOfDay_ScriptableObject todSO;
    ...
    private void LateUpdate()
    {
        ...
        else if (timeOfDay > 20f || timeOfDay < 6f)
        {
